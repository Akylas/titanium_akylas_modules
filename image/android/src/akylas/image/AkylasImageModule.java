...
@Kroll.module(name="AkylasImage", id="akylas.image")
public class AkylasImageModule extends KrollModule
{

	// Standard Debugging variables
	private static final String TAG = "AkylasImageModule";
