...
public class MGLMarker extends AkylasMarker<LatLng> {
    private static final String TAG = "MGLMarker";
    ...
    public MGLMarker(final AnnotationProxy p) {
        super(p);
    }
    ...
    protected void handleSetImage(Bitmap bitmap) {
        ...
        Icon icon = iconFromBitmap(bitmap);
    ...
    public void setPosition(final LatLng point) {
        ...
        runInUiThread(new CommandNoReturn() {
            public void execute() {
                ...
                AkMapView mapView = (AkMapView) proxy.getMapView();
                if (mapView != null) {
