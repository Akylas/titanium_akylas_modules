...
@Kroll.proxy(creatableInModule = AkylasMapboxGLModule.class, propertyAccessors = {
        ...
        AkylasMapboxGLModule.PROPERTY_ANIMATION_DURATION,
        AkylasMapboxGLModule.PROPERTY_FOCUS_OFFSET
})
...
//      AsyncResult result = null;
    ...
    private void handleSnapshot() 
    {
        ...
        if (view instanceof AkMapView) {
            ((AkMapView) view).snapshot();
        }
    }
    ...
    public void updateCamera(HashMap value)
    {
        ...
        TiUIView view = peekView();
        if (view instanceof AkMapView) {
            ((AkMapView) view).updateCamera(TiConvert.toHashMap(value));
        } else {
