...
//            break;
    ...
    public void setZIndex(float value) {
        ...
        if (layer != null && mapView != null) {
            ((AkMapView) mapView).resortLayers();
        }
    }
...
//    TileDataSource cachedDataSource;
    ...
    public void removeFromMap() {
        if (layer != null && mapView != null) {
            ((AkMapView) mapView).getMap().removeLayer(layer);
...
//        cachedDataSource = null;
    ...
    private Source createSource(String sSource) {
        Source result = null;
        if (sSource == null) {
            return null;
        }
            ...
            if (source != null) {
                if (cacheable) {
                    ...
                    cachedDataSource = new PersistentCacheTileDataSource(source,
                            AkylasMapboxGLModule.getMapCacheFolder() + "/" + id + ".db");
                }
            }
        }
