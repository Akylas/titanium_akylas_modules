...
@interface AkylasGMSMapView : MGLMapView
...
@interface AkylasGooglemapView : AkylasMapBaseView<SMCalloutViewDelegate, MGLMapViewDelegate, UIGestureRecognizerDelegate>
{
}
