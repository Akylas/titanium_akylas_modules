 ...
 */
__attribute__ ((visibility("default"))) @interface NTVectorElementEventListener : NSObject
{
  void *swigCPtr;
  BOOL swigCMemOwn;
}
 ...
 */
+(NTVectorElementEventListener*)swigCreatePolymorphicInstance:(void*)cPtr swigOwnCObject:(BOOL)cMemoryOwn;
