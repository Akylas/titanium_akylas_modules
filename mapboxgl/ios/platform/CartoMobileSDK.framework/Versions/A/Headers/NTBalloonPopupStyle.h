 ...
 * @param titleField The metadata field name for title.<br>
 ...
 * @param descField The metadata field for description.<br>
 ...
 */
-(id)initWithColor: (NTColor*)color attachAnchorPointX: (float)attachAnchorPointX attachAnchorPointY: (float)attachAnchorPointY causesOverlap: (BOOL)causesOverlap hideIfOverlapped: (BOOL)hideIfOverlapped horizontalOffset: (float)horizontalOffset verticalOffset: (float)verticalOffset placementPriority: (int)placementPriority scaleWithDPI: (BOOL)scaleWithDPI cornerRadius: (int)cornerRadius leftColor: (NTColor*)leftColor leftImage: (NTBitmap*)leftImage leftMargins: (NTBalloonPopupMargins*)leftMargins rightColor: (NTColor*)rightColor rightImage: (NTBitmap*)rightImage rightMargins: (NTBalloonPopupMargins*)rightMargins titleColor: (NTColor*)titleColor titleFontName: (NSString*)titleFontName titleField: (NSString*)titleField titleFontSize: (int)titleFontSize titleMargins: (NTBalloonPopupMargins*)titleMargins titleWrap: (BOOL)titleWrap descColor: (NTColor*)descColor descFontName: (NSString*)descFontName descField: (NSString*)descField descFontSize: (int)descFontSize descMargins: (NTBalloonPopupMargins*)descMargins descWrap: (BOOL)descWrap strokeColor: (NTColor*)strokeColor strokeWidth: (int)strokeWidth triangleWidth: (int)triangleWidth triangleHeight: (int)triangleHeight;
/**
