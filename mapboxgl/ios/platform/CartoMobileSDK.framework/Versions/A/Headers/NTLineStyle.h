 ...
 * @param lineJoinType The join type for the line.<br>
 * @param stretchFactor The color for the line.<br>
 * @param width The width for the line.
 */
-(id)initWithColor: (NTColor*)color bitmap: (NTBitmap*)bitmap clickWidth: (float)clickWidth lineEndType: (enum NTLineEndType)lineEndType lineJoinType: (enum NTLineJoinType)lineJoinType stretchFactor: (float)stretchFactor width: (float)width;
/**
