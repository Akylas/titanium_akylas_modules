...
public class TiViewTemplate {
    ...
    public TiViewTemplate(String id, KrollDict properties) {
    ...
    public KrollProxy generateProxy(Class topViewProxyClass, KrollDict data, KrollProxy proxy)
    {
        return KrollProxy.createProxy(topViewProxyClass, null, new Object[] { properties }, null);
    }
