...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','akylas.camera.js')
	...
	f = os.path.join(cwd,'Classes','AkylasCameraModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','akylas.camera.js']
