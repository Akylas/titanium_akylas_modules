...
//    NSMutableDictionary *evt = [super eventDictAtPoint:point onSpace:space];
...
//    if (clampInteraction == YES && coordinate == CPTCoordinateX) {
////        newRange = ((CPTXYPlotSpace*)space).yRange;
//        float newMinX = newRange.locationDouble;
//        float newMaxX = newRange.locationDouble;
//        if (newMinX < minXValue && newMaxX <= maxXValue ||
//            newMinX >= minXValue && newMaxX > maxXValue) {
