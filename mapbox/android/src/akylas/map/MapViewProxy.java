...
public class MapViewProxy extends MapDefaultViewProxy
{
	...
	public MapViewProxy() {
        ...
        if (!googlePlayServicesAvailable) {
            if (hasListeners(TiC.EVENT_ERROR)) {
                ...
                data.putCodeAndMessage(googlePlayServicesState, AkylasMapModule.getGoogleServiceStateMessage(googlePlayServicesState));
    ...
    {
        if (((AkylasMapView)view).getMap() != null) {
...
//		AsyncResult result = null;
    ...
    public void updateCamera(HashMap value)
    {
	    ...
	    TiUIView view = peekView();
        if (view instanceof AkylasMapView) {
            ((AkylasMapView) view).updateCamera(TiConvert.toKrollDict(value));
        }
    }
