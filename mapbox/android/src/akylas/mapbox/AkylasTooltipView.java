...
public class AkylasTooltipView extends RelativeLayout
{
	private static final String TAG = "AkylasTooltipView";
	...
	public AkylasTooltipView(Context context)
	{
		super(context);
		...
		leftPane.setTag(AkylasMapboxModule.PROPERTY_LEFT_PANE);
		...
		rightPane.setTag(AkylasMapboxModule.PROPERTY_RIGHT_PANE);
		params = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
