...
import akylas.location.locationmanager.ILastLocationFinder;
...
public class GingerbreadLastLocationFinder implements ILastLocationFinder {
   ...
   * @param maxAccuracy Minimum distance before we require a location update.
   * @param minTime Minimum time required between location updates.
   * @return The most accurate and / or timely previously detected location.
   */
  public Location getLastBestLocation(float maxAccuracy, long minTime) {
    ...
    if (locationListener != null && (bestTime < minTime || bestAccuracy > maxAccuracy)) { 
      IntentFilter locIntentFilter = new IntentFilter(SINGLE_LOCATION_UPDATE_ACTION);
      context.registerReceiver(singleUpdateReceiver, locIntentFilter);      
      locationManager.requestSingleUpdate(Manager.criteria, singleUpatePI);
    }
