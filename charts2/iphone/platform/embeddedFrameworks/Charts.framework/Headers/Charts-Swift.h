...
/**
  ...
  If \code
  animate(...)
  \endcode is called, no further calling of \code
  invalidate()
  \endcode is necessary to refresh the chart.
...
/**
  When true, axis labels are controlled by the \code
  granularity
  \endcode property.
...
/**
  ...
  Use \code
  nil
  \endcode to use the formatter calculated by the chart.
*/
...
/**
  ...
  \code
  true
  \endcode if focing the y-label count is enabled. Default: false
*/
...
/**
  This property is deprecated - Use \code
  axisMinimum
  \endcode instead.
*/
...
/**
  ...
  \code
  true
  \endcode if a DataSet was removed, \code
  false
  \endcode ifno DataSet could be removed.
*/
...
/**
  ...
  \code
  true
  \endcode if an entry was removed, \code
  false
  \endcode ifno Entry was found that meets the specified requirements.
*/
...
- (ChartTransformer * _Nonnull)getTransformerForAxis:(enum AxisDependency)forAxis;
...
/**
  ...
  <em>optional feature, can return \code
  false
  \endcode ifnot implemented</em>
  ...
  \code
  true
  \endcode if the entry was added successfully, \code
  false
  \endcode ifthis feature is not supported
*/
...
/**
  ...
  \code
  true
  \endcode if the entry was removed successfully, \code
  false
  \endcode ifthe entry does not exist or if this feature is not supported
*/
...
*/
- (UIColor * _Nonnull)colorAtIndex:(NSInteger)atIndex;
- (void)resetColors;
...
/**
  ...
  \code
  true
  \endcode if value highlighting is enabled for this dataset
*/
@property (nonatomic, readonly) BOOL isHighlightEnabled;
/**
...
/**
  ...
  \code
  true
  \endcode if the valueFormatter object of this DataSet is null.
*/
...
/**
  ...
  Return \code
  .Default
  \endcode to use the default legend form.
*/
...
/**
  ...
  Return \code
  NaN
  \endcode to use the default legend form size.
*/
...
/**
  ...
  Return \code
  NaN
  \endcode to use the default legend form line width.
*/
...
/**
  ...
  \code
  true
  \endcode if y-value drawing is enabled, \code
  false
  \endcode ifnot
*/
...
/**
  ...
  \code
  true
  \endcode if this DataSet is visible inside the chart, or \code
  false
  \endcode ifit is currently hidden.
*/
...
/**
  ...
  \param alpha alpha to apply to the set \code
  color
  \endcode
...
/**
  ...
  \endcode after setting a new value.
...
/**
  ...
  \code
  true
  \endcode if the entry was removed successfully, else if the entry does not exist
*/
- (BOOL)removeEntry:(ChartDataEntry * _Nonnull)entry;
/**
  Removes the first Entry (at index 0) of this DataSet from the entries array.
...
/**
  \code
  true
  \endcode if drawing the marker is enabled when tapping on values
  (use the \code
  marker
  \endcode property to specify a marker)
*/
...
/**
  ...
  \code
  true
  \endcode if the chart is empty (meaning it’s data object is either null or contains no entries).
*/
- (BOOL)isEmpty;
/**
...
/**
  ...
  \code
  true
  \endcode if values can be highlighted via tap gesture, \code
  false
  \endcode ifnot.
*/
...
/**
  ...
  \code
  true
  \endcode if there are values to highlight, \code
  false
  \endcode ifthere are no values to highlight.
*/
...
/**
  ...
  \code
  true
  \endcode if chart continues to scroll after touch up, \code
  false
  \endcode ifnot.
*/
...
/**
  the number of maximum visible drawn values on the chart only active when \code
  drawValuesEnabled
  \endcode is enabled
*/
@property (nonatomic, readonly) NSInteger maxVisibleCount;
...
/**
  Sets custom offsets for the current \code
  ChartViewPort
  \endcode (the offsets on the sides of the actual chart window). Setting this will prevent the chart from automatically calculating it’s offsets. Use \code
  resetViewPortOffsets()
  \endcode to undo this.
  ONLY USE THIS WHEN YOU KNOW WHAT YOU ARE DOING, else use \code
  setExtraOffsets(...)
  \endcode.
*/
- (void)setViewPortOffsetsWithLeft:(CGFloat)left top:(CGFloat)top right:(CGFloat)right bottom:(CGFloat)bottom;
/**
  Resets all custom offsets set via \code
  setViewPortOffsets(...)
  \endcode method. Allows the chart to again calculate all offsets automatically.
*/
...
/**
  ...
  \code
  true
  \endcode if zooming via double-tap is enabled \code
  false
  \endcode ifnot.
*/
...
/**
  ...
  You might want to disable this when using inside a \code
  NSUIScrollView
  \endcode
  <em>default</em>: true
*/
...
/**
  ...
  \code
  true
  \endcode if drawing the grid background is enabled, \code
  false
  \endcode ifnot.
*/
...
/**
  ...
  \code
  true
  \endcode if drawing the borders rectangle is enabled, \code
  false
  \endcode ifnot.
*/
...
/**
  ...
  (encapsulated in a \code
  CGPoint
  \endcode). This method transforms pixel coordinates to
...
*/
- (id <IBarLineScatterCandleBubbleChartDataSet> _Null_unspecified)getDataSetByTouchPointWithPoint:(CGPoint)pt;
/**
...
/**
  ...
  \code
  true
  \endcode if pinch-zoom is enabled, \code
  false
  \endcode ifnot
*/
...
/**
  ...
  \code
  true
  \endcode if both drag offsets (x and y) are zero or smaller.
*/
...
/**
  ...
  \code
  true
  \endcode if either the left or the right or both axes are inverted.
*/
...
/**
  ...
  \code
  true
  \endcode if auto scaling on the y axis is enabled.
*/
...
/**
  Set this to \code
  true
  \endcode to make the highlight operation full-bar oriented, \code
  false
  \endcode to make it highlight single values (relevant only for stacked).
...
/**
  ...
  \code
  true
  \endcode the highlight is be full-bar oriented, \code
  false
  \endcode ifsingle-value
*/
@property (nonatomic, readonly) BOOL isHighlightFullBarEnabled;
@property (nonatomic, readonly, strong) BarChartData * _Nullable barData;
/**
  ...
  \code
  true
  \endcode if drawing values above bars is enabled, \code
  false
  \endcode ifnot
*/
@property (nonatomic, readonly) BOOL isDrawValueAboveBarEnabled;
/**
  ...
  \code
  true
  \endcode if drawing shadows (maxvalue) for each bar is enabled, \code
  false
  \endcode ifnot
*/
@property (nonatomic, readonly) BOOL isDrawBarShadowEnabled;
...
*/
- (ChartHighlight * _Nullable)getStackedHighlightWithHigh:(ChartHighlight * _Nonnull)high set:(id <IBarChartDataSet> _Nonnull)set xValue:(double)xValue yValue:(double)yValue;
/**
  \param entry 
...
/**
  Determines how to round DataSet index values for \code
  ChartDataSet.entryIndex(x, rounding)
  \endcode when an exact x-value is not found.
*/
...
/**
  ...
  \endcode to make the highlight operation full-bar oriented, \code
  false
  \endcode to make it highlight single values
*/
@property (nonatomic) BOOL highlightFullBarEnabled;
/**
...
*/
+ (NSArray<NSValue *> * _Nonnull)reduceWithDouglasPeuker:(NSArray<NSValue *> * _Nonnull)points tolerance:(CGFloat)tolerance;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (ChartDefaultFillFormatter * _Nullable)withBlock:(CGFloat (^ _Nonnull)(id <ILineChartDataSet> _Nonnull, id <LineChartDataProvider> _Nonnull))block;
- (CGFloat)getFillLinePositionWithDataSet:(id <ILineChartDataSet> _Nonnull)dataSet dataProvider:(id <LineChartDataProvider> _Nonnull)dataProvider;
@end
...
/**
  Set to \code
  true
  \endcode if the DataSet should be drawn filled (surface), and not just as a line.
...
/**
  ...
  \code
  true
  \endcode if filled drawing is enabled, \code
  false
  \endcode ifnot
*/
...
*/
- (UIColor * _Nullable)getCircleColorAtIndex:(NSInteger)atIndex;
/**
...
/**
  ...
  returns:
  The offset for drawing at the specific \code
  point
  \endcode.
...
/**
  ...
  this is currently supported only for \code
...
/**
  ...
  <ul>
    <li>
      ...
      Call \code
      resetCustom(...)
      \endcode to re-enable automatic calculation (and then \code
      notifyDataSetChanged()
      \endcode is needed).
    </li>
  </ul>
...
/**
  Calling this will disable the custom legend entries (set by \code
  setLegend(...)
  \endcode). Instead, the entries will again be calculated automatically (after \code
  notifyDataSetChanged()
  \endcode is called).
*/
- (void)resetCustom;
/**
  ...
  \code
  true
  \endcode if a custom legend entries has been set
*/
@property (nonatomic, readonly) BOOL isLegendCustom;
/**
  This constructor is deprecated - Use \code
  init(entries:)
  \endcode
*/
...
/**
  This function is deprecated - Use \code
  entries
  \endcode
*/
...
/**
  ...
  A \code
  nil
  \endcode label will start a group.
...
/**
  ...
  \code
  None
  \endcode will avoid drawing a form, and any related space.
  \code
  Empty
  \endcode will avoid drawing a form, but keep its space.
  \code
  Default
  \endcode will use the Legend’s default.
*/
@property (nonatomic) enum ChartLegendForm form;
/**
...
/**
  ...
  \code
  true
  \endcode if the inner tips of the slices are visible behind the hole, \code
  false
  \endcode if not.
*/
...
/**
  \code
  true
  \endcode if the hole in the center of the pie-chart is set to be visible, \code
  false
  \endcode ifnot
*/
...
/**
  ...
  \code
  true
  \endcode if drawing entry labels is enabled, \code
  false
  \endcode ifnot
*/
...
/**
  ...
  \code
  true
  \endcode if drawing x-values is enabled, \code
  false
  \endcode ifnot
*/
...
/**
  ...
  \code
  true
  \endcode if this range contains (if the value is in between) the given value, \code
  false
  \endcode ifnot.
*/
...
+ (id <IShapeRenderer> _Nonnull)rendererForShape:(enum ScatterShape)shape;
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithLabel:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithValues:(NSArray<ChartDataEntry *> * _Nullable)values label:(NSString * _Nullable)label OBJC_DESIGNATED_INITIALIZER;
...
/**
  ...
  \code
  true
  \endcode if the chart is fully zoomed out on it’s y-axis (vertical).
*/
...
/**
  ...
  \code
  true
  \endcode if the chart is fully zoomed out on it’s x-axis (horizontal).
*/
...
/**
  ...
  \code
  true
  \endcode if the chart is not yet fully zoomed out on the x-axis
*/
...
/**
  ...
  \code
  true
  \endcode if the chart is not yet fully zoomed in on the x-axis
*/
...
/**
  ...
  \code
  true
  \endcode if the chart is not yet fully zoomed out on the y-axis
*/
...
/**
  ...
  \code
  true
  \endcode if the chart is not yet fully zoomed in on the y-axis
*/
...
/**
  width of the x-axis labels in pixels - this is automatically calculated by the \code
  computeSize()
  \endcode methods in the renderers
*/
@property (nonatomic) CGFloat labelWidth;
/**
  height of the x-axis labels in pixels - this is automatically calculated by the \code
  computeSize()
  \endcode methods in the renderers
*/
@property (nonatomic) CGFloat labelHeight;
/**
  width of the (rotated) x-axis labels in pixels - this is automatically calculated by the \code
  computeSize()
  \endcode methods in the renderers
*/
@property (nonatomic) CGFloat labelRotatedWidth;
/**
  height of the (rotated) x-axis labels in pixels - this is automatically calculated by the \code
  computeSize()
  \endcode methods in the renderers
*/
...
/**
  ...
  word wrapping is done using \code
  (value width * labelRotatedWidth)
  \endcode
  note:
...
/**
  ...
  \code
  true
  \endcode if word wrapping the labels is enabled
*/
@property (nonatomic, readonly) BOOL isWordWrapEnabled;
/**
...
/**
  ...
  \code
  true
  \endcode if this axis needs horizontal offset, \code
  false
  \endcode ifno offset is needed.
*/
