...
{
    NSBundle* bndl = [NSBundle bundleWithPath:[[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:RESOURCES_PREFIX]];
    if (self = [super initWithNibName:@"MPAdBrowserController" bundle:bndl])
    {
