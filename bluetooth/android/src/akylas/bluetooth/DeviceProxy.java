...
public class DeviceProxy extends KrollProxy
{
            ...
            if (BluetoothDevice.ACTION_BOND_STATE_CHANGED.equals(action)) {              
                ...
                if (state == BluetoothDevice.BOND_BONDED && prevState == BluetoothDevice.BOND_BONDING) {
                    if (hasListeners("pairing")) {
                        ...
                        data.put("device", AkylasBluetoothModule.dictFromDevice(getDevice()));
	...
	protected void initActivity(Activity activity) {
	    Activity realActivity = AkylasBluetoothModule.getCurrentOrRootActivity();
        super.initActivity(realActivity);
        //we only destroy if main app activity is destroyed
        ((TiBaseActivity) realActivity).addOnLifecycleEventListener(this);
	...
	private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MESSAGE_STATE_CHANGE:
                ...
                switch (msg.arg1) {
                case AkylasBluetoothModule.STATE_CONNECTED:
                    fireEvent("connected");
                    break;
...
//                break;
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                if (secure) {
                    tmp = AkylasBluetoothModule.getBTAdapter().listenUsingRfcommWithServiceRecord(mSocketServiceName,
                        mUUID);
                } else {
                    tmp = AkylasBluetoothModule.getBTAdapter().listenUsingInsecureRfcommWithServiceRecord(
        ...
        public void run() {
            ...
            while (mState != AkylasBluetoothModule.STATE_CONNECTED) {
                try {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            AkylasBluetoothModule.getBTAdapter().cancelDiscovery();
...
//        start();
    ...
    private synchronized void setState(int state) {
        ...
        } else if (mState == AkylasBluetoothModule.STATE_DISCONNECTED && hasListeners("disconnected")) {
...
//        mHandler.obtainMessage(MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    ...
    public synchronized void start() {
        ...
        setState(AkylasBluetoothModule.STATE_LISTEN);
...
//        mDevice = device;
    ...
    public void write(byte[] out) {
        ...
        synchronized (this) {
            if (mState != AkylasBluetoothModule.STATE_CONNECTED) return;
            r = mConnectedThread;
        }
