...
public class MergeTileDataSource extends TileDataSource {
    TileDataSource[] sources;
    TileDataSource firstSource;
    int sourcesCount;
    int minZoom = -1000;
    int maxZoom = 1000;
    public MergeTileDataSource(TileDataSource... sources) {
        ...
        for(int i = 1; i< sourcesCount; i++) {
            ...
            minZoom = Math.max(minZoom, source.getMinZoom());
            maxZoom = Math.min(maxZoom, source.getMaxZoom());
...
//               if (result == null) {
//                   result = sourceResult;
//               } else if (!result.isReplaceWithParent()){
