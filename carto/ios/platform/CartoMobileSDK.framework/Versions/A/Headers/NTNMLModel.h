 ...
 */
-(id)initWithGeometry: (NTGeometry*)geometry sourceModelData: (NTBinaryData*)sourceModelData;
/**
 ...
 * @param sourceModelData Serialized data for 3D model.
 */
-(id)initWithPos: (NTMapPos*)pos sourceModelData: (NTBinaryData*)sourceModelData;
