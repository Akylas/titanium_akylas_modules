...
exports.init = function (logger, config, cli, appc) {
	...
	cli.addHook('build.pre.compile', function (data, finished) {
		...
		shouldNotCompile = (!/store/.test(data.target) && data.tiapp.properties.hasOwnProperty('ti.compilejs') && data.tiapp
			.properties['ti.compilejs'].value === false);
