...
public class AkylasGoogleMapModule extends
    ...
    public static void onAppCreate(TiApplication app) {
        ...
        map.put("AkylasMap.View", ViewProxy.class.getName());
        map.put("AkylasMap.Annotation", AnnotationProxy.class.getName());
        map.put("AkylasMap.Route", RouteProxy.class.getName());
        map.put("AkylasMap.TileSource", TileSourceProxy.class.getName());
