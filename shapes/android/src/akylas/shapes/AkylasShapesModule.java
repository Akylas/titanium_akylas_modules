...
public class AkylasShapesModule extends ProtectedModule {
    ...
    @Kroll.constant
    public static final int ALIGNMENT_MIDDLE = 4;
    @Kroll.constant
    public static final int ALIGNMENT_BOTTOM = 5;
    @Kroll.constant
    ...
    public static int lineCapFromString(final String value) {
        switch (value) {
        case "square": {
            return CAP_SQUARE;
        }
    ...
    public static int lineJoinFromString(final String value) {
        switch (value) {
        case "miter": {
            return JOIN_MITER;
        }
    ...
    public static void onAppCreate(TiApplication app) {
        ...
        map.put("AkylasShapes.Circle",
                akylas.shapes.CircleProxy.class.getName());
        map.put("AkylasShapes.Line", akylas.shapes.LineProxy.class.getName());
        map.put("AkylasShapes.PieSlice",
                akylas.shapes.PieSliceProxy.class.getName());
        map.put("AkylasShapes.Rect", akylas.shapes.RectProxy.class.getName());
        map.put("AkylasShapes.RoundedRect",
                akylas.shapes.RoundedRectProxy.class.getName());
